...
let emotes_only = (process.env.EMOTES_ONLY === 'true');
let emotes_only_absolute = (process.env.EMOTES_ONLY_ABSOLUTE === 'true');
...
exports.getEmoteOnlyMode = function(){
	if(emotes_only)
	{
		return true;
	}
...
exports.setEmoteOnlyMode = function(val){
	if(val)
	{
		emotes_only = true;
	}
...
exports.getEmoteAbsolute = function(){
	if(emotes_only_absolute)
	{
		return true;
	}
	else
...
exports.setEmoteAbsolute = function(val){
	if(val)
	{
		emotes_only_absolute = true;
	}
	else
	{
		emotes_only_absolute = false;
	}
};
